# Generated by Django 2.2.8 on 2019-12-26 17:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_character', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='starwars.Character', verbose_name='personnage source')),
                ('target', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='effects', to='starwars.Character', verbose_name='personnage cible')),
            ],
            options={
                'verbose_name': 'effet',
