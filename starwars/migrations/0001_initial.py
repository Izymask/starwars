# Generated by Django 2.2.8 on 2019-12-31 16:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_type', models.CharField(choices=[('active', 'actif'), ('passive', 'passif')], default='passive', max_length=7, verbose_name="type d'activation")),
                ('duration_type', models.CharField(blank=True, choices=[('direct', 'direct (one shot)'), ('permanent', 'permanent'), ('turn', 'nombre de tours'), ('fight', 'durée du combat')], max_length=10, verbose_name='type de durée')),
