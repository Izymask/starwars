# Generated by Django 2.2.8 on 2019-12-30 10:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stunned', models.PositiveSmallIntegerField(default=0, verbose_name='étourdi(e) (nombres de tours)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration_type', models.CharField(blank=True, choices=[('permanent', 'permanent'), ('source_turn', 'nombre de tours - source'), ('target_turn', 'nombre de tours - cible'), ('fight', 'durée du combat')], max_length=11, verbose_name='type de durée')),
            ],
            options={
                'verbose_name': 'effet',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill', models.CharField(blank=True, choices=[('brawl', 'méléé'), ('gunnery', 'artillerie'), ('lightsaber', 'sabre laser'), ('mechanics', 'mécanique'), ('medecine', 'médecine'), ('melee', 'corps à corps'), ('ranged_heavy', 'distance (armes lourdes)'), ('ranged_light', 'distance (armes légères)')], max_length=10, null=True, verbose_name='compétence associée')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nb_turn', models.IntegerField(default=0, verbose_name='nombre de tours')),
                ('effect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='starwars.Effect', verbose_name='effet')),
                ('source_character', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='generated_effects', to='starwars.Character', verbose_name='personnage source')),
                ('source_equipment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='generated_effects', to='starwars.Equipment', verbose_name='equipement source')),
                ('source_talent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='generated_effects', to='starwars.Talent', verbose_name='talent source')),
